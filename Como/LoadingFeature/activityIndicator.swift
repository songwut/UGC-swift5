...
public class ActivityLoad: UIView {
    ...
    public func animationDidStop(_ anim: CAAnimation, finished flag: Bool) {
        if hidesWhenCompleted {
            Timer.scheduledTimer(timeInterval: dhHidesWhenCompletedDelay, target: self, selector: #selector(self.hiddenLoadingView), userInfo: nil, repeats: false)
        } else {
            status = .Completion
    ...
    private func initialize() {
        ...
        NotificationCenter.default.addObserver(self, selector:#selector(self.resetAnimations), name: UIApplication.didBecomeActiveNotification, object: nil)
    }
...
extension ActivityLoad: CAAnimationDelegate {
